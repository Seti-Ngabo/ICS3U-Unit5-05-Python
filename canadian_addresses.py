...
def full_address(street_number, street_name, city, province, postal, apt_number=None):
    ...
    try:
        ...
        if apt_number != None:
            location = full_address(
                street_number, street_name, city, province, postal, apt_number
            )

        else:
            location = full_address(street_number, street_name, city, province, postal)
